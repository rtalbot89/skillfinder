angular.module("find", ["ngRoute", "ngResource", "ui.bootstrap"])
                    ...
                    .then(
                        function(result) {
                            ...
                            for (i = 0; i < result.data.length; i++) {
                                ...
                                var hasOu = arrayFunc.hasValue(nodeTracker, d.ou.Name, "ou");
                                if (hasOu === -1) {
                                ...
                                for (var j = 0; j < d.skills.length; j++) {
                                    ...
                                    hasId = arrayFunc.hasValue(nodeTracker, s.Name, "skill");
                                    if (hasId === -1) {
    ...
    .factory("arrayFunc",
        function () {
            return {
                hasValue : function (myArray, searchTerm, property) {
                    for (var i = 0, len = myArray.length; i < len; i++) {
                        if (myArray[i].hasOwnProperty(property) && myArray[i][property] === searchTerm) return i;
                    }
                    return -1;
                }
            }
